...
class ReportCenterPage(QWidget):
    def __init__(self, controller: StudioController, parent: QWidget | None = None) -> None:
        ...
        self.preview_context_pane.setProperty("desktopEvidenceRail", True)
        ...
        self.delivery_rail_console.setProperty("desktopRailConsole", True)
        self.delivery_rail_console.setMinimumHeight(122)
        self.delivery_rail_console.setMaximumHeight(132)
        ...
        self.delivery_rail_action_bar.setProperty("compactDeliveryActionMatrix", True)
        self.delivery_rail_action_bar.setMinimumHeight(61)
        self.delivery_rail_action_bar.setMaximumHeight(64)
        ...
        for index, button in enumerate((
            ...
            button.setProperty("compactDeliveryAction", True)
    ...
    def _build_filter_bar(self) -> CardFrame:
        ...
        card.setProperty("reportFilterDock", True)
        card.setProperty("compactReportFilter", True)
    ...
    def _build_report_command_deck(self) -> CardFrame:
        ...
        card.setProperty("compactReportCommandDeck", True)
        ...
        self.report_command_summary_card.setProperty("compactReportCommandSummary", True)
        self.report_command_summary_card.setMaximumHeight(86)
        self.report_command_summary_card.setMinimumWidth(190)
        self.report_command_summary_card.setMaximumWidth(240)
        ...
        self.delivery_closure_strip.setProperty("compactClosureMatrix", True)
        self.delivery_closure_strip.setMaximumHeight(92)
    ...
    def _report_command_tile(self, key: str, title: str) -> CardFrame:
        ...
        tile.setProperty("compactClosureTile", True)
