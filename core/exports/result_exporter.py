...
FULL_OUTPUT_SCHEMA = [
    ...
    ("licor_profile_id", "acquisition", "real"),
    ("licor_status", "acquisition", "real"),
    ("licor_signal_status", "acquisition", "real"),
    ("licor_diagnostic_word_status", "acquisition", "real"),
    ("licor_co2_signal_mean", "acquisition", "real"),
    ("licor_co2_signal_min", "acquisition", "real"),
    ("licor_h2o_signal_mean", "acquisition", "real"),
    ("licor_h2o_signal_min", "acquisition", "real"),
    ("licor_reference_signal_mean", "acquisition", "real"),
    ("licor_reference_signal_min", "acquisition", "real"),
    ("licor_cell_pressure_mean_kpa", "acquisition", "real"),
    ("licor_cell_temp_mean_c", "acquisition", "real"),
    ("licor_fault_count", "acquisition", "real"),
    ("licor_active_faults", "acquisition", "real"),
    ("licor_calibration_profile_id", "acquisition", "real"),
    ("licor_calibration_source_file", "acquisition", "real"),
    ("licor_calibration_normalization_command", "acquisition", "real"),
    ("licor_provenance", "acquisition", "real"),
    ("licor_limitations", "acquisition", "real"),
...
class ResultExporter:
        ...
        *,
        ...
        manifest_payload = {
            ...
            "network_method_fields": [
                ...
                "PRIMARY_ANALYZER_METHOD",
                "PRIMARY_ANALYZER_FAMILY",
                "PRIMARY_ANALYZER_SIGNAL_STATUS",
                "PRIMARY_ANALYZER_FAULT_COUNT",
                "PRIMARY_ANALYZER_CALIBRATION_PROFILE_ID",
                "PRIMARY_ANALYZER_SOURCE_FILE",
                "PRIMARY_ANALYZER_NORMALIZATION_COMMAND",
                "CLOCK_SYNC_STATUS",
                "CLOCK_SYNC_METHOD",
                "CLOCK_SYNC_SOURCE",
            ...
            "primary_analyzer_fields": [
                ...
                "licor_status",
                "licor_signal_status",
                "licor_diagnostic_word_status",
                "licor_co2_signal_mean",
                "licor_h2o_signal_mean",
                "licor_reference_signal_mean",
                "licor_cell_pressure_mean_kpa",
                "licor_cell_temp_mean_c",
                "licor_fault_count",
                "licor_active_faults",
                "licor_calibration_profile_id",
                "licor_calibration_source_file",
                "licor_calibration_normalization_command",
            ],
    ...
    def _rp_row(self, window: WindowRPResult) -> dict[str, Any]:
        ...
        return {
            ...
            "licor_profile_id": diagnostics.get("licor_profile_id", ""),
            "licor_status": diagnostics.get("licor_status", ""),
            "licor_signal_status": diagnostics.get("licor_signal_status", ""),
            "licor_diagnostic_word_status": diagnostics.get("licor_diagnostic_word_status", ""),
            "licor_co2_signal_mean": diagnostics.get("licor_co2_signal_mean", ""),
            "licor_co2_signal_min": diagnostics.get("licor_co2_signal_min", ""),
            "licor_h2o_signal_mean": diagnostics.get("licor_h2o_signal_mean", ""),
            "licor_h2o_signal_min": diagnostics.get("licor_h2o_signal_min", ""),
            "licor_reference_signal_mean": diagnostics.get("licor_reference_signal_mean", ""),
            "licor_reference_signal_min": diagnostics.get("licor_reference_signal_min", ""),
            "licor_cell_pressure_mean_kpa": diagnostics.get("licor_cell_pressure_mean_kpa", ""),
            "licor_cell_temp_mean_c": diagnostics.get("licor_cell_temp_mean_c", ""),
            "licor_fault_count": diagnostics.get("licor_fault_count", ""),
            "licor_active_faults": "|".join(diagnostics.get("licor_active_faults", []) or [])
            if isinstance(diagnostics.get("licor_active_faults"), list)
            else diagnostics.get("licor_active_faults", ""),
            "licor_calibration_profile_id": diagnostics.get("licor_calibration_profile_id", ""),
            "licor_calibration_source_file": diagnostics.get("licor_calibration_source_file", ""),
            "licor_calibration_normalization_command": diagnostics.get("licor_calibration_normalization_command", ""),
            "licor_provenance": diagnostics.get("licor_provenance", ""),
            "licor_limitations": json.dumps(diagnostics.get("licor_limitations", []), ensure_ascii=False) if diagnostics.get("licor_limitations") else "",
    ...
    def _full_output_rows(self, *, rp_result: RPRunResult | None, spectral_result: SpectralRunResult | None, mode: str) -> list[dict[str, Any]]:
        ...
        for window_id in ordered_ids:
            ...
            row = {
                ...
                "licor_profile_id": diagnostics.get("licor_profile_id", "") if diagnostics else "",
                "licor_status": diagnostics.get("licor_status", "") if diagnostics else "",
                "licor_signal_status": diagnostics.get("licor_signal_status", "") if diagnostics else "",
                "licor_diagnostic_word_status": diagnostics.get("licor_diagnostic_word_status", "") if diagnostics else "",
                "licor_co2_signal_mean": diagnostics.get("licor_co2_signal_mean", "") if diagnostics else "",
                "licor_co2_signal_min": diagnostics.get("licor_co2_signal_min", "") if diagnostics else "",
                "licor_h2o_signal_mean": diagnostics.get("licor_h2o_signal_mean", "") if diagnostics else "",
                "licor_h2o_signal_min": diagnostics.get("licor_h2o_signal_min", "") if diagnostics else "",
                "licor_reference_signal_mean": diagnostics.get("licor_reference_signal_mean", "") if diagnostics else "",
                "licor_reference_signal_min": diagnostics.get("licor_reference_signal_min", "") if diagnostics else "",
                "licor_cell_pressure_mean_kpa": diagnostics.get("licor_cell_pressure_mean_kpa", "") if diagnostics else "",
                "licor_cell_temp_mean_c": diagnostics.get("licor_cell_temp_mean_c", "") if diagnostics else "",
                "licor_fault_count": diagnostics.get("licor_fault_count", "") if diagnostics else "",
                "licor_active_faults": "|".join(diagnostics.get("licor_active_faults", []) or [])
                if diagnostics and isinstance(diagnostics.get("licor_active_faults"), list)
                else (diagnostics.get("licor_active_faults", "") if diagnostics else ""),
                "licor_calibration_profile_id": diagnostics.get("licor_calibration_profile_id", "") if diagnostics else "",
                "licor_calibration_source_file": diagnostics.get("licor_calibration_source_file", "") if diagnostics else "",
                "licor_calibration_normalization_command": diagnostics.get("licor_calibration_normalization_command", "") if diagnostics else "",
                "licor_provenance": diagnostics.get("licor_provenance", "") if diagnostics else "",
                "licor_limitations": json.dumps(diagnostics.get("licor_limitations", []), ensure_ascii=False) if diagnostics and diagnostics.get("licor_limitations") else "",
    ...
    def _fluxnet_half_hourly_row(
        ...
        *,
        ...
        return {
            ...
            "PRIMARY_ANALYZER_PROFILE_ID": diagnostics.get(
                "primary_analyzer_profile_id",
                primary_analyzer_detail.get("profile_id", ""),
            ),
            "PRIMARY_ANALYZER_STATUS": diagnostics.get(
                "primary_analyzer_status",
                primary_analyzer_detail.get("status", ""),
            ),
            "PRIMARY_ANALYZER_METHOD": primary_analyzer_detail.get("artifact_type", ""),
            "PRIMARY_ANALYZER_FAMILY": primary_analyzer_detail.get("instrument_family", ""),
            "PRIMARY_ANALYZER_SIGNAL_STATUS": primary_analyzer_detail.get("signal_status", ""),
            "PRIMARY_ANALYZER_FAULT_COUNT": primary_analyzer_detail.get("fault_count", 0),
            "PRIMARY_ANALYZER_CALIBRATION_PROFILE_ID": primary_analyzer_detail.get("calibration_profile_id", ""),
            "PRIMARY_ANALYZER_SOURCE_FILE": primary_analyzer_detail.get("calibration_source_file", ""),
            "PRIMARY_ANALYZER_NORMALIZATION_COMMAND": primary_analyzer_detail.get("calibration_normalization_command", ""),
            "CLOCK_SYNC_STATUS": diagnostics.get("clock_sync_status", ""),
            "CLOCK_SYNC_METHOD": diagnostics.get("clock_sync_method", ""),
            "CLOCK_SYNC_SOURCE": diagnostics.get("clock_sync_source", ""),
            "CLOCK_SYNC_MEAN_OFFSET_S": diagnostics.get("clock_sync_mean_offset_s", ""),
    ...
    def _fluxnet_gap_row(
        ...
        *,
        ...
        return {
            ...
            "METHOD_DEVIATION_NOTES": "",
            "PRIMARY_ANALYZER_PROFILE_ID": "",
            "PRIMARY_ANALYZER_STATUS": "gap_fill",
            "PRIMARY_ANALYZER_METHOD": "",
            "PRIMARY_ANALYZER_FAMILY": "",
            "PRIMARY_ANALYZER_SIGNAL_STATUS": "",
            "PRIMARY_ANALYZER_FAULT_COUNT": 0,
            "PRIMARY_ANALYZER_CALIBRATION_PROFILE_ID": "",
            "PRIMARY_ANALYZER_SOURCE_FILE": "",
            "PRIMARY_ANALYZER_NORMALIZATION_COMMAND": "",
            "CLOCK_SYNC_STATUS": "",
...
FLUXNET_HALF_HOURLY_SCHEMA = [
    ...
    ("PRIMARY_ANALYZER_PROFILE_ID", "text", "Primary CO2/H2O analyzer profile id used for RP processing"),
    ("PRIMARY_ANALYZER_STATUS", "text", "Primary analyzer diagnostic status"),
    ("PRIMARY_ANALYZER_METHOD", "text", "Primary analyzer diagnostic artifact/method id"),
    ("PRIMARY_ANALYZER_FAMILY", "text", "Primary analyzer instrument family"),
    ("PRIMARY_ANALYZER_SIGNAL_STATUS", "text", "Primary analyzer signal diagnostic status"),
    ("PRIMARY_ANALYZER_FAULT_COUNT", "count", "Primary analyzer active diagnostic fault count"),
    ("PRIMARY_ANALYZER_CALIBRATION_PROFILE_ID", "text", "Primary analyzer calibration profile id"),
    ("PRIMARY_ANALYZER_SOURCE_FILE", "text", "Primary analyzer calibration/source file"),
    ("PRIMARY_ANALYZER_NORMALIZATION_COMMAND", "text", "Primary analyzer telemetry normalization command"),
...
AMERIFLUX_FIELD_MAP = {
    ...
    "PRIMARY_ANALYZER_PROFILE_ID": "PRIMARY_ANALYZER_PROFILE_ID",
    "PRIMARY_ANALYZER_STATUS": "PRIMARY_ANALYZER_STATUS",
    "PRIMARY_ANALYZER_METHOD": "PRIMARY_ANALYZER_METHOD",
    "PRIMARY_ANALYZER_FAMILY": "PRIMARY_ANALYZER_FAMILY",
    "PRIMARY_ANALYZER_SIGNAL_STATUS": "PRIMARY_ANALYZER_SIGNAL_STATUS",
    "PRIMARY_ANALYZER_FAULT_COUNT": "PRIMARY_ANALYZER_FAULT_COUNT",
    "PRIMARY_ANALYZER_CALIBRATION_PROFILE_ID": "PRIMARY_ANALYZER_CALIBRATION_PROFILE_ID",
    "PRIMARY_ANALYZER_SOURCE_FILE": "PRIMARY_ANALYZER_SOURCE_FILE",
    "PRIMARY_ANALYZER_NORMALIZATION_COMMAND": "PRIMARY_ANALYZER_NORMALIZATION_COMMAND",
...
ICOS_FIELD_MAP = {
    ...
    "PRIMARY_ANALYZER_PROFILE_ID": "PrimaryAnalyzerProfileId",
    "PRIMARY_ANALYZER_STATUS": "PrimaryAnalyzerStatus",
    "PRIMARY_ANALYZER_METHOD": "PrimaryAnalyzerMethod",
    "PRIMARY_ANALYZER_FAMILY": "PrimaryAnalyzerFamily",
    "PRIMARY_ANALYZER_SIGNAL_STATUS": "PrimaryAnalyzerSignalStatus",
    "PRIMARY_ANALYZER_FAULT_COUNT": "PrimaryAnalyzerFaultCount",
    "PRIMARY_ANALYZER_CALIBRATION_PROFILE_ID": "PrimaryAnalyzerCalibrationProfileId",
    "PRIMARY_ANALYZER_SOURCE_FILE": "PrimaryAnalyzerSourceFile",
    "PRIMARY_ANALYZER_NORMALIZATION_COMMAND": "PrimaryAnalyzerNormalizationCommand",
