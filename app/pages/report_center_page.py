...
class ReportCenterPage(QWidget):
    ...
    def _build_delivery_gate_card(self) -> CardFrame:
        ...
        self.delivery_gate_hero_card.setMinimumHeight(0)
        self.delivery_gate_hero_card.setMaximumHeight(0)
        self.delivery_gate_hero_card.setVisible(False)
        ...
        self.delivery_gate_scroll.setMinimumHeight(78)
        self.delivery_gate_scroll.setMaximumHeight(82)
        ...
        self.delivery_gate_grid_body.setMinimumHeight(78)
    ...
    def _delivery_gate_tile(self, key: str, title: str, hint: str) -> CardFrame:
        ...
        title_label.setMaximumWidth(30)
        title_label.setSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
        status_chip = chip("检查", "warning")
        status_chip.setProperty("closureStage", True)
        status_chip.setAlignment(Qt.AlignCenter)
        status_chip.setMinimumWidth(26)
        status_chip.setMaximumWidth(32)
        status_chip.setMinimumHeight(16)
