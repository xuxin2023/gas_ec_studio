...
class ECProcessingPage(QWidget):
    def __init__(self, controller: StudioController, parent: QWidget | None = None) -> None:
        ...
        step_header = QVBoxLayout()
        step_header.setContentsMargins(0, 0, 0, 0)
        step_header.setSpacing(TOKENS.spacing_xs)
        self.step_tree_title = section_title("处理流程", "按步骤导航，状态同屏。")
        step_header.addWidget(self.step_tree_title)
        step_status = QHBoxLayout()
        step_status.setContentsMargins(0, 0, 0, 0)
        step_status.setSpacing(TOKENS.spacing_xs)
        ...
        step_status.addWidget(self.step_count_chip)
        step_status.addWidget(self.step_active_chip, 1)
        step_header.addLayout(step_status)
