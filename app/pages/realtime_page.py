...
class RealtimePage(QWidget):
    ...
    def _build_summary_bar(self) -> CardFrame:
        ...
        session_card.setMinimumHeight(86)
        session_card.setMaximumHeight(108)
        ...
        for key, title in (
            ...
            metric_card.setMinimumHeight(86)
            metric_card.setMaximumHeight(108)
    ...
    def _build_bottom_area(self) -> CardFrame:
        ...
        self.event_list.setMinimumHeight(116)
        ...
        self.frame_list.setMinimumHeight(116)
        ...
        self.parsed_text.setMinimumHeight(92)
        ...
        self.raw_text.setMinimumHeight(92)
