...
- GPS/PTP-style acquisition clock synchronization now applies offset/drift/event corrections before RP/FCC window slicing and daemon_telemetry v1 parses ptp4l/phc2sys/chrony/GPSD/PPS-style logs for lock, offset, jitter, and dialect provenance; direct hardware clock discipline control and real target-host fixture validation remain incomplete.
